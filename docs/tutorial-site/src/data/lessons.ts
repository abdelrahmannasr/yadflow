...
export const MODULES: Module[] = [
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    lessons: [
      ...
      {
        id: 'why-three-parts',
        title: 'Three parts, and earned automation',
        duration: '4 min',
        level: 'beginner',
        ...
        quiz: [
          {
            ...
            options: [
              'The Build checks',
              'The spec step',
              'The engineer review and every Shape step',
              'None — everything can be automated',
            ],
            answer: 2,
            explain: 'The engineer review and all Shape states stay human-approved permanently. Only safe Build steps can earn automation.',
          },
        ],
      },
    ],
