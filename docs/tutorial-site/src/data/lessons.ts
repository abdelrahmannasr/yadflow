      ...
      },
      {
        ...
        body: [
          ...
          { kind: 'list', items: [
            ...
            '**risk-map** — warnings only, never a failure: a directory this change adds with no level in `.sdlc/risk-map`, a line whose directory is gone, or a level still `guessed`.',
          ] },
