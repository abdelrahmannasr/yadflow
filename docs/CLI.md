...
lower its own count; a `guessed` level will count there exactly as a `confirmed` one does, since a level
only raises the count, never lowers it. E67 will ask who has committed to those directories.
