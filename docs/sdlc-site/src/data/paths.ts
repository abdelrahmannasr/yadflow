...
// status reuses the SDLC step status; bookingStatus carries the .sdlc artifact
...
const setupSteps: FlowStep[] = [
  {
    ...
    actor: "system",
    status: "installed",
    bookingStatus: "_bmad/sdlc/ registered",
  ...
  },
  {
    ...
    actor: "system",
    status: "connected",
    bookingStatus: ".sdlc/design.json",
  ...
  },
  {
    ...
    actor: "system",
    status: "connected",
    bookingStatus: ".sdlc/testing.json",
  ...
  },
  {
    ...
    actor: "system",
    status: "connected",
    bookingStatus: ".sdlc/learning.json",
...
function gateStep(
  ...
  return {
    ...
    actor: "reviewer",
    status: "in-review",
    bookingStatus: "reviews/*.md · approvals.json",
...
const frontSteps: FlowStep[] = [
  ...
  gateStep("epic", "epic.md", "owner + 1 reviewer (base rule)", "#1e8449"),
  {
    ...
    actor: "architect",
    status: "draft",
    bookingStatus: "architecture.md · contract.md",
  ...
  gateStep("architecture", "architecture.md", "escalated: base + a domain owner per repo (contract)", "#ca6f1e"),
  {
    ...
    actor: "ux",
    status: "draft",
    bookingStatus: "ui-design.md · DESIGN.md",
    trigger: "yad-ui {epic}",
    handler: "yad-ui",
  ...
  gateStep("ui", "ui-design.md", "owner + 1 reviewer (base rule)", "#1e8449"),
  {
    ...
    actor: "pm",
    status: "draft",
    bookingStatus: "stories/EP-<slug>-S0N.md",
  ...
  gateStep("stories", "stories/", "per-repo: base + a domain owner for every touched repo", "#ca6f1e"),
  {
    ...
    bookingStatus: "test-cases.md · test-links.json",
...
const buildSteps: FlowStep[] = [
  ...
  },
  {
    ...
    actor: "dev",
    status: "committed",
    bookingStatus: "feat/<story>-<task> branch",
  ...
  },
  {
    ...
    bookingStatus: "checks/*.sh · yad-checks.yml",
  ...
  },
  {
    ...
    actor: "dev",
    status: "pr-ready",
    bookingStatus: "pull_request_template.md",
...
const automationSteps: FlowStep[] = [
  {
    ...
    actor: "system",
    status: "running",
    bookingStatus: "build-state/<story-id>.json",
  ...
  },
  {
    ...
    actor: "engineer",
    status: "earned",
    bookingStatus: "state.json (automation dial)",
  ...
  },
  {
    ...
    actor: "engineer",
    status: "reversible",
    bookingStatus: "automation.kill_switch",
