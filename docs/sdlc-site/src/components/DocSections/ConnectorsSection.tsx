...
const FACTS = [
  ...
  'Connecting or refreshing a repo also drafts its risk map, .sdlc/risk-map in the code repo: the AI reads the code and marks each directory high, medium or low as guessed; a person confirms each level in a PR. A PR touching a high directory asks for one more approver — a guessed level counts too. No names, and yad update never touches the file.',
];
