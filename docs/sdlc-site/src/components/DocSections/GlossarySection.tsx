...
const TERM_GROUPS = [
  ...
  },
  {
    phase: 'Gates & roles',
    steps: [
      'Review gate — the reusable team approval: 1 approver who is not the author (the base), all threads resolved, and the review PR/MR merged. Anyone with access to the repo can approve; yadflow keeps no list of people.',
