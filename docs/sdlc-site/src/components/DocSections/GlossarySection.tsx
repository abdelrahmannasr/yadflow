...
const TERM_GROUPS = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Approval count — how many distinct people a step asks to approve: base 1 + risk step, capped at the active people less one (never below 1). Only the base is enforced until E73; the gate prints the rest as a shortfall.',
