...
const TERM_GROUPS = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Active people — how many people committed or approved lately, counted live from the approval and ship records plus git authorship, never from a stored list. The window scales with how fast the team merges. Printed once per epic on `yad gate status` and `yad gate sync`, and beside the ask in a generated review PR. It caps each gate\'s count at the active people less one — one seat is left for the author — and the cap is reported, not enforced, until E73. An unreadable source reads as "NOT COUNTED", never as a small number, and then no cap is shown.',
