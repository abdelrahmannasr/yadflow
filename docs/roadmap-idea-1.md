...
`payments/**` above is an example of such a directory, not a tag. E66 and E67 shipped both tiers on the
Build half, reported: the count, and the people who have worked in those directories lately.
