...
ledger `yad migrate` converts `EP-discovery` into it; a verified ledger keeps the old spelling, which is
still read. The E75 row below records the decisions.
