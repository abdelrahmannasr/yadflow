...
```json
{
  ...
  "default_branch": "main",
  "bridge_enabled": true,                                     // open review PRs/MRs on the hub for Shape reviews; travels WITH platform — verified mode is both (isBridge), so never true beside platform: null (#186)
