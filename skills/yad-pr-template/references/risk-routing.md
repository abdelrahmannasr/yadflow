...
enforced, on the Shape gates for now, and on the Build half it stays reported even once the Shape cap is enforced: `yad open-pr` prints the count capped by the active
